...
from asr.whisper_live.whisper_utils import (mel_filters, load_audio_wav_format,
                                            pad_or_trim)
...
if __name__=="__main__":
    ...
    model = WhisperTRTLLM("/root/TensorRT-LLM/frontend/whisper/whisper_small_en", False, "../../assets", device="cuda")
